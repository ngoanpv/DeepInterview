...
Chưa có bản phát hành được gắn tag — DeepInterview đang ở giai đoạn trước `v0.1`. Hãy theo dõi [Releases](https://github.com/your-org/deepinterview/releases) và phần Tin tức ở trên. Metadata trích dẫn nằm ở [`CITATION.cff`](CITATION.cff).
...
- **🌐 Ưu tiên tiếng Anh & đa ngôn ngữ** — mọi chuỗi hiển thị cho người dùng đều được i18n hóa (mặc định EN, đã có VI); ngôn ngữ là thiết lập theo từng phiên và STT/TTS/giọng nói định tuyến theo ngôn ngữ. Mỗi ngôn ngữ là một "gói" cắm-vào-là-chạy.
- **🧠 Chuẩn bị cá nhân hóa** — một pipeline LangGraph đọc CV + JD, nghiên cứu công ty mục tiêu, so sánh khoảng cách, và một **Bộ lập kế hoạch câu hỏi** tính trước kế hoạch, đường cong độ khó, rubric và các câu hỏi tiếp nối — để vòng lặp trực tiếp luôn nhanh.
...
- **📚 Huấn luyện viên ôn tập** *(đang phát triển)* — biến khoảng trống của bạn thành một vòng học có dẫn nguồn, có trích dẫn, dựa trên một sidecar tri thức LightRAG.
...
**Thấy hữu ích? [Tặng chúng tôi một ⭐](https://github.com/your-org/deepinterview)** — tốc độ tăng sao là thứ giúp một dự án được khám phá, và nó thật sự có ích.

## 🌐 Cộng đồng

- 💬 **Discord** — tham gia kênh chat build-in-public _(link mời TBD — mở khi ra mắt)_.
- 🗣️ **[GitHub Discussions](https://github.com/your-org/deepinterview/discussions)** — câu hỏi, ý tưởng, yêu cầu gói ngôn ngữ.
- 🐛 **[Issues](https://github.com/your-org/deepinterview/issues)** — lỗi & tính năng (có sẵn template).
